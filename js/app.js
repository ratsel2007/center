 ...
 */
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".feautures__slider")) new core(".feautures__slider", {
            ...
            if (document.querySelector(".sertificate__slider")) new core(".sertificate__slider", {
                ...
                loop: true,
                pagination: {
                    el: ".sertificate .swiper-pagination",
                    type: "fraction",
                    formatFractionCurrent: function(number) {
                        if (number < 10) number = "0" + number;
                        return number;
                ...
                navigation: {
                    prevEl: ".sertificate .swiper-button-prev",
                    nextEl: ".sertificate .swiper-button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1
...
***************************************************************************** */
        ...
        const popupButtons = document.querySelectorAll(".popup-data__button");
        ...
        popupButtons.forEach((button => {
            button.addEventListener("click", (() => {
                ...
                script_html.classList.remove("popup-show");
            }));
        }));
        function map() {
            ymaps.ready(init);
            function init() {
                var myMap = new ymaps.Map("map", {
                    controls: [],
                    center: [ 55.11744206959288, 36.61859199999994 ],
                    zoom: 18
                });
                let myPlacemark = new ymaps.Placemark([ 55.11779720393929, 36.6182592 ], {}, {
                    hasBalloon: false,
                    hideIconOnBalloonOpen: false,
                    iconLayout: "default#imageWithContent",
                    iconImageHref: "img/map-label.png",
                    iconImageSize: [ 124, 166 ],
